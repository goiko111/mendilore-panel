...
export async function GET(req: Request){
  ...
  const tests = [
    ...
    { key: "upsert_desglose (0020)", check: async () => await s.rpc("upsert_reserva_misterplan", { payload: { id_reserva: "test-diag-" + Date.now(), importe_alojamiento: 100, importe_complementarios: 5, canal: "test", habitacion: "test", fecha_in: "2026-01-01", fecha_out: "2026-01-02", noches: 1, huesped_nombre: "T", importe_total: 105, importe_moneda: "EUR", anticipo: 0, pendiente_cobro: 105, estado_reserva: "test", estado_cobro: "test", fecha_reserva: "2026-01-01T00:00:00" } }) },
