...
export async function GET(req: Request){
  ...
  const tests = [
    ...
    { key: "upsert_desglose (0020)", check: async () => await s.rpc("upsert_reserva_misterplan", { payload: { id_reserva: "diag-selftest", importe_alojamiento: 100, importe_complementarios: 5, canal: "otro", habitacion: "cala", fecha_in: "2000-01-01", fecha_out: "2000-01-02", noches: 1, huesped_nombre: "DIAG SELFTEST", importe_total: 105, importe_moneda: "EUR", anticipo: 0, pendiente_cobro: 105, estado_reserva: "cancelada", estado_cobro: "cancelado", fecha_reserva: "2000-01-01T00:00:00" } }) },
